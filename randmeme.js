...
function randomMeme(subreddit) {
    subreddit = (typeof subreddit === 'string' && subreddit.length !== 0) ? subreddit : 'meme';
...
function all(subreddit) {
    ...
    function emitRandomImage(subreddit) {
        randomMeme(subreddit).then(imageUrl => {
